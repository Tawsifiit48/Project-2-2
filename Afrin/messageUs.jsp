...
<input class = "input-style opacity-box" name = "subject" type = "text" placeholder = "subject" required>

<hr>

<textarea class = "input-style opacity-box" name = "body" placeholder = "Enter your message" required></textarea><hr>
