...
<head>
    ...
    <title>Transport Enquiry System</title>
    ...
    <link rel="stylesheet" href="css2/review.css">
     <link rel="stylesheet" href="css2/place.css">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <br>
                <a href="dhaka.html" class="btn" target="#">search transport</a>
            </div>
        </div>

        <div class="box">
            <img src="images2/Pic2.jpg" alt="">
            <div class="content">
                ...
                <a href="Bandarban.html" class="btn">search transport</a>
            </div>
        </div>

        <div class="box">
            <img src="images2/Pic3.jpg" alt="">
            <div class="content">
                ...
                <br>
                <a href="cox'sBazar.html" class="btn">search transport</a>
            </div>
        </div>

        <div class="box">
            <img src="images2/Pic4.jpg" alt="">
            <div class="content">
                ...
                <a href="rangamati.html" class="btn">search transport</a>
            </div>
        </div>

        <div class="box">
            <img src="images2/Pic5.jpg" alt="">
            <div class="content">
...
<section class="footer">
    ...
    <h1 class="credit"> created by <span class="typing">Mayesha Miran Afrin Tawsif </span> | Team - 3! </h1>
