...
%>
<form action="addNewProductAction.jsp?temp=2" method="post">
...
<div class="left-div">
 <h3>Enter Train Name</h3>
 <input class="input-style" type="text" name="busname" placeholder="Enter TrainName"required>
